...
public class Constants {
  ...
  public static final String SETTINGS_HOST_NAME = "edge.wingify.net";
  public static final String COLLECTOR_HOST_NAME = "collect.wingify.net";
  public static final String VWO_HOST_NAME = "dev.visualwebsiteoptimizer.com";
  ...
  public static final String WINGIFY_FS_ENVIRONMENT = "vwo_fs_environment";
  public static final String HTTPS_PROTOCOL = "https";

  public static final int RANDOM_ALGO = 1;
  public static final String WINGIFY_META_MEG_KEY = "_vwo_meta_meg_";
